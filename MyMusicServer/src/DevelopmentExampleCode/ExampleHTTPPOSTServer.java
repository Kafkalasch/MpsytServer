...
public class ExampleHTTPPOSTServer extends Thread {
    ...
    public ExampleHTTPPOSTServer(Socket client) {
        ...
        try {
            ...
            if (httpMethod.equals("GET")) {
                ...
                if (httpQueryString.equals("/")) {
                    ...
                    String responseString = ExampleHTTPPOSTServer.HTML_START
                            ...
                            + ExampleHTTPPOSTServer.HTML_END;
    ...
    public void sendResponse(int statusCode, String responseString, boolean isFile) throws Exception {
        ...
        if (isFile) {
            ...
            responseString = ExampleHTTPPOSTServer.HTML_START + responseString + ExampleHTTPPOSTServer.HTML_END;
    ...
    public static void main(String args[]) throws Exception {
        ...
        while (true) {
            ...
            (new ExampleHTTPPOSTServer(connected)).start();
        }
    }
}
